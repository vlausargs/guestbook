...
const CustomPagination = ({ currPage, totalPage, setPage }) => {
    ...
    return (
        <div className="text black mt-4 flex flex-row pl-10 pb-4">
            {currPage > 1 && (
                <div
            ...
            {pageNumbers.map((num) => (
                <div
                    ...
                    className={
                        'flex flex-col ' +
                        classNames(
                            ' rounded border border-blue-500 py-2 px-4 font-semibold hover:border-transparent hover:bg-blue-500 hover:text-white',
                            {
